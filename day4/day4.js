...
const b=10;
 if(a==10 && b==11)
    {logical && //if both condition is true then result true otherwise false
 ...
 if(a==11 || b==11)
    {//if both false the result will be false otherwise true
...
false? console.log("Your are at  the last stage.."):console.log("still Young Enjoy") //when the condition is true then it give us the first condition other wise second condition
var1==31? console.log("Your are at  the last stage.."):console.log("still Young Enjoy")
